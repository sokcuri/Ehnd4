...
int main()
{
	...
	//char *trans = ezt::J2K_TranslateMMNT(0, "｜トップへ戻る｜携帯サイトGetchu.com mobile｜ダウンロードサイトDL.Getchu.com｜アフィリエイト｜スタッフ募集｜お問い合わせ｜\n"\
